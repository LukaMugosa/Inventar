...
/**
 * Criteria class for the {@link me.amplitudo.inventar.domain.EquipmentService} entity. This class is used
 * in {@link me.amplitudo.inventar.web.rest.EquipmentServiceResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /equipment-services?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class EquipmentServiceCriteria implements Serializable, Criteria {
    ...
    public EquipmentServiceCriteria() {
    }

    public EquipmentServiceCriteria(EquipmentServiceCriteria other) {
    ...
    @Override
    public EquipmentServiceCriteria copy() {
        return new EquipmentServiceCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final EquipmentServiceCriteria that = (EquipmentServiceCriteria) o;
        return
    ...
    public String toString() {
        return "EquipmentServiceCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
