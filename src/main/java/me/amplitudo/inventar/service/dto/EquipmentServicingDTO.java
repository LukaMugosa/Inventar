...
/**
 * A DTO for the {@link me.amplitudo.inventar.domain.EquipmentServicing} entity.
 */
public class EquipmentServicingDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof EquipmentServicingDTO)) {
            return false;
        }

        return id != null && id.equals(((EquipmentServicingDTO) o).id);
    }
